              ...
              <form onSubmit={handleSendOTP} className="space-y-6">
                ...
                <div className="flex items-start gap-4 pt-2 group">
                  ...
                  <div className="grid gap-1.5 leading-none">
                    ...
                    >
                      I agree to receive SMS messages from TopRank AI. By providing your phone number and submitting this form, you consent to receive text messages from TopRank AI regarding your account and services. Message frequency varies. Message and data rates may apply. Reply STOP to cancel or HELP for help. View our <Link href="/privacy-policy" className="text-blue-600 hover:underline font-bold">Privacy Policy</Link> | <Link href="/terms-and-conditions" className="text-blue-600 hover:underline font-bold">Terms of Service</Link>.
                    </label>
                  </div>
                </div>
