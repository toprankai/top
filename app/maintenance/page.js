...
async function getBranding() {
  try {
    ...
    return setting?.value || { appName: "TopRank AI", supportEmail: "support@toprank.ai", supportPhone: "(619) 625-6148" }
  } catch (err) {
    return { appName: "TopRank AI", supportEmail: "support@toprank.ai", supportPhone: "(619) 625-6148" }
  }
}
