      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 min-w-0">
          {filteredProjects.map((project) => (
            <Card key={project.id} className="group hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 border-slate-200 rounded-2xl overflow-hidden flex flex-col min-w-0">
              <CardHeader className="pb-4 pt-5 px-4 sm:px-6">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    <CardTitle className="text-lg font-bold text-slate-900 line-clamp-1 break-words group-hover:text-blue-600 transition-colors">
              ...
              <CardContent className="px-4 sm:px-6 pb-5 sm:pb-6 pt-0 flex-1 flex flex-col justify-between space-y-5">
