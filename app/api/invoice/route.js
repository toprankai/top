...
export async function GET(request) {
  try {
    ...
    const isIndiaReferer =
      referer.includes('/in/') ||
      referer.includes('/in?') ||
      referer.endsWith('/in') ||
      (isLocalHost && !referer.includes('/us'))
...
<body>
    <div class="invoice-container">
        ...
        <header class="header">
            <div class="brand">
                <div class="logo-box">
                    ${logoBase64 ? `<img src="${logoBase64}" alt="TopRank AI">` : `<div style="font-weight:900; font-size:24px; color:var(--primary)">TopRank AI</div>`}
                </div>
                <div class="brand-name">TopRank AI</div>
            </div>
