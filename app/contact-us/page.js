  ...
  useEffect(() => {
    const detectRegion = () => {
      ...
      if (typeof window !== 'undefined') {
        ...
        if (isLocalHost && !path.startsWith('/us')) return 'in';
      }
            ...
            <div className="space-y-8">
              <div className="glass-panel p-8 rounded-3xl border-slate-200/60 transition-all hover:shadow-2xl">
                ...
                <div className="space-y-6">
                  ...
                  <a href="mailto:info@skale.ai" className="flex items-center gap-4 group p-4 rounded-2xl hover:bg-purple-50 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-slate-900">info@skale.ai</p>
                    </div>
                  </a>
