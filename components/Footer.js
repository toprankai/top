...
const ADDRESS_IN = 'P-10 Patel Nagar, New Delhi, 110008'
const ADDRESS_US = '1470 HurOntario St Mississauga Ontario L5G 3H4'
const PHONE_IN = '+91 91523 03009'
const PHONE_US = '+1 (437) 291-3099'
...
export default function Footer() {
  ...
  const address = isIndia ? ADDRESS_IN : ADDRESS_US
  const phone = isIndia ? PHONE_IN : PHONE_US
      ...
      <div className="container mx-auto max-w-7xl">
          ...
          <div className="col-span-2 lg:col-span-1">
            <div className="flex flex-col items-center lg:items-start gap-4 mb-6">
              ...
              <p className="text-[#526484] font-bold text-sm max-w-xs text-center lg:text-left">
                The all-in-one <span className="text-blue-600">AI-powered</span> platform for local search growth.
              </p>
            </div>
          </div>
        ...
        <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-[14px] font-bold text-[#526484] space-y-1">
            <p>All Rights Reserved © 2026 <span className="text-blue-600">TopRank AI</span> – Your Agency Growth Partner</p>
            <p className="text-[12px] text-slate-500/80 font-medium" suppressHydrationWarning>
              Address: {address}
            </p>
            <p className="text-[12px] text-slate-500/80 font-medium" suppressHydrationWarning>
              Phone: <a href={`tel:${phone.replace(/\s|\(|\)|-/g, '')}`} className="hover:text-blue-600">{phone}</a>
            </p>
          </div>
