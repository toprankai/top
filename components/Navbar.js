...
export default function Navbar() {
  ...
  const navItemClass = "inline-flex items-center gap-1 whitespace-nowrap px-4 py-2 rounded-full border border-slate-200 bg-white/85 text-[13px] leading-none font-semibold tracking-tight text-slate-700 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-200"
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <button
                ...
                aria-haspopup="menu"
              >
                Platform <ChevronDown className={`w-3.5 h-3.5 transition-transform ${platformMenuOpen ? 'rotate-180' : ''}`} />
              </button>

              <div className={`absolute left-0 top-full pt-3 z-50 transition-all duration-200 ${platformMenuOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-1'}`}>
                <div className="w-44 rounded-2xl border border-slate-200 bg-white shadow-xl p-2">
                  <Link href="/" className="block rounded-xl px-3 py-2 text-sm font-medium text-slate-700 hover:bg-blue-50 hover:text-blue-700">
                    Overview
                  </Link>
                  <Link href="/#pricing" className="block rounded-xl px-3 py-2 text-sm font-medium text-slate-700 hover:bg-blue-50 hover:text-blue-700">
                    Pricing
                  </Link>
                  <Link href="/contact-us" className="block rounded-xl px-3 py-2 text-sm font-medium text-slate-700 hover:bg-blue-50 hover:text-blue-700">
                    Contact Us
                  </Link>
                </div>
              </div>
            ...
            <Link href="/ai-qr-code" className={navItemClass}>
              <span className="whitespace-nowrap">AI QR Code</span>
            ...
            <Link href="/contact-us" className={navItemClass}>Contact Us</Link>
